...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h2 className="text-xl font-bold user-ink mb-5" style={{ fontFamily: 'DM Serif Display, serif' }}>How the platform works</h2>
      ...
      <div className="rounded-2xl p-6 text-white" style={{ background: 'linear-gradient(135deg, rgba(10,22,40,0.82), rgba(30,58,95,0.78))', backdropFilter: 'blur(12px)' }}>
